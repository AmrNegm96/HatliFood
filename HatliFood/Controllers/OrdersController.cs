...
namespace HatliFood.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Orders.Include(o => o.DeliveryGuyUser).Include(o => o.Restaurant);
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderDate,Bid,BuyerUserId,Rid,RestaurantId,OrderState,Did,DeliveryGuyUserId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderDate,Bid,BuyerUserId,Rid,RestaurantId,OrderState,Did,DeliveryGuyUserId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
